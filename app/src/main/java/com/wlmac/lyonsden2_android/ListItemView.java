...
// TODO: Test that image placement works!
...
public class ListItemView extends View {
    ...
    private int paddingLeft = getPaddingLeft(), paddingTop = getPaddingTop(), paddingBottom = getPaddingBottom();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (image != null) {
            ...
            xPos = paddingLeft + image.getIntrinsicWidth() + 8;
            // Size the image
